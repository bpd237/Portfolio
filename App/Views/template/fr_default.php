...
<html>
	...
	<body>
		<div id="page">
			<div class="left">
				...
				<nav class="menu">
					<ul>
						...
						<li><a href="Skills"><i class="fa menu_ico">&#xf19d;</i><i class="supp">COMPETENCES</i></a></li>
			...
			<footer>
				<p>copyright &copy; 2018 Tous droits reservé ! par &lt;BPD_237/&gt;</p>
				<div>
					<form method="post">
						<input type="hidden" name="lang" value="lang">
						<input class="active_lang lang" type="submit" name="lang" value="" alt="fr" title="Français">
