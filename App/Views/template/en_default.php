...
<html>
	...
	<body>
			...
			<div class="left">
				...
				<nav class="menu">
					<ul>
						...
						<li><a href="About_me"><i class="fa menu_ico">&#xf129;</i><i class="supp">ABOUT ME</i></a></li>
						<li><a href="Skills"><i class="fa menu_ico">&#xf19d;</i><i class="supp">SKILLS</i></a></li>
						<li><a href="Worked"><i class="fa menu_ico">&#xf121;</i><i class="supp">WORKED</i></a></li>
			...
			<footer>
				...
				<div>
					<form method="post">
						...
						<input class="active_lang lang" type="submit" name="lang" value="" alt="en" title="English">
		...
		<script type="text/javascript" src="Dist/js/image_hover.js"></script>
